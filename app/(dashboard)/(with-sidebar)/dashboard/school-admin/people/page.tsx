...
export default async function SchoolAdminPeoplePage() {
  const user = await requireRole(['school_admin']);
  const t = await getTranslations('schoolAdmin.people');
  const classes = await getScheduleSummaryForUser(user.id, 'school_admin');
